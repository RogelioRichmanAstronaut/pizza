  ...
  return (
    ...
    <div className={styles.right}>
        <div className={styles.wrapper}>
              ...
              <div className={styles.totalText}>
                  <b className={styles.totalTextTitle}>IVA:</b>${(order.total*0.16).toFixed(2)}
              </div>
              <div className={styles.totalText}>
                  <b className={styles.totalTextTitle}>Discount:</b>$0.00
              </div>
              <div className={styles.totalText}>
                  <b className={styles.totalTextTitle}>Total:</b>${(order.total*1.16).toFixed(2)}
              </div>
...
export const getServerSideProps = async ({ params }) =>{
    const res = await axios.get(`https://pizza.danisando.com/api/orders/${params.id}`);
    return {
